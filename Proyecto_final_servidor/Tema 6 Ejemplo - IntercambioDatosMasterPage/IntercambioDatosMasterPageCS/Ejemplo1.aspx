<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="Ejemplo1.aspx.cs" Inherits="Ejemplo1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Cabecera" Runat="Server">
</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="DatosUsuario" Runat="Server">
        <div style="text-align: right">
            <asp:Label ID="lblIdentificadorUsuario" runat="server"></asp:Label>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MantenerUsuarios.aspx.cs" Inherits="MantenerUsuarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [USUARIO] WHERE ([Rol] = @Rol)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="U" Name="Rol" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
        <asp:GridView ID="grdUsuarios" Class="table" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="Login" DataSourceID="SqlDataSource1" AllowPaging="True" OnSelectedIndexChanged="grdUsuarios_SelectedIndexChanged">
            <Columns>
        ...
        <div class="row">
            ...
            <!--<asp:Button ID="btnEditar" class="btn btn-default" runat="server" Text="Editar" visible="false" OnClick="btnEditar_Click"/>
